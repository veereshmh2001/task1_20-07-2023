...
public class CountryDTO {
	...
	public CountryDTO(int id, String name, String capitalCity, long population, boolean independent,
			...
			String nationalBird, String nationalSport, String primeMinister) {
		super();
		this.id = id;
		this.name = name;
	...
	public int hashCode() {
		...
		result = prime * result + ((primeMinister == null) ? 0 : primeMinister.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (primeMinister == null) {
			if (other.primeMinister != null)
				return false;
		} else if (!primeMinister.equals(other.primeMinister))
			return false;
		return true;
	}
	...
	public String toString() {
		return "CountryDTO [id=" + id + ", name=" + name + ", capitalCity=" + capitalCity + ", population=" + population
				...
				+ ", nationalBird=" + nationalBird + ", nationalSport=" + nationalSport + ", primeMinister="
				+ primeMinister + "]";
	}
