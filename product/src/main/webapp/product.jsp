...
<body>
	...
	<form action="veeru" method="post" class="container" name="myForm"
		...
		<div class="design">
			<label for="name"> Name </label><br><span id="nameError"  style='color:red;' ></span><input type="text"
		...
		<div class="design">
			<label for="productType">Product Type</label> <select
				id="productType" class="form-select" name="type" placeholder="Choose...">
		...
		<div class="design">
			<label for="price">Price</label><br> <input type="number"
				...
				placeholder="Ex.100000 in rupees">
		</div>
		<br>
		<div class="design">
			<label for="brand">Brand</label><br> <input type="text"
...
alert('Name must be between 3 and 20 characters.');
	document.getElementById('nameError').innerHTML='Name must be between 3 and 20';
return false;
}
else{
